...
const Contact = ({
  ...
  return (
    <div className="flex flex-col gap-10  font-LexendDeca ">
      ...
      <div>
        <div className="grid p:grid-cols-1 d:grid-cols-2 gap-5 font-LexendDeca font-extralight">
          <div className="p:h-auto d:h-[50vh] w-full border-r">
            <iframe src={ContactData?.GoogleMap} className="h-[300px] w-[80%]">
              {" "}
            </iframe>
          </div>
          <div className="">
            <div className="flex flex-col gap-5">
              <h1 className="text-[26px] font-bold uppercase">Tun Tattoo</h1>
